...
from coding_agent.models import (
    AgentState, CodeQuestionSpec, CodeTaskSpec, PatchReport, ReadonlyInput,
)
...
def test_public_package_contract() -> None:
    assert coding_agent.__all__ == [
        ...
        "CommandResult", "PatchReport", "ReadonlyInput", "RepoContext", "Snippet",
        "list_sessions", "read_session_card", "resume_code_task", "run_code_question",
...
def test_controller_prompt_and_action_contracts() -> None:
    ...
    assert _schema_hash(ACTION_SCHEMA) == "8a9ae3cfb36c36d8e9b7461d1e353f675a310858bfd60cc4685fa4b0526601ae"
...
def test_public_model_field_contracts() -> None:
    assert list(CodeTaskSpec.model_fields) == [
        ...
        "allowed_paths", "readonly_inputs", "max_steps", "max_extra_steps_after_progress",
    ...
    assert list(ReadonlyInput.model_fields) == ["id", "path", "description"]
